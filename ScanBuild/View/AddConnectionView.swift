...
struct AddConnectionView: View {
    ...
    @State private var fromFloor: Floor? = nil
    @State private var selectedTransitionZone: TransitionZone? = nil
    @State private var fromTransitionZone: TransitionZone? = nil
    ...
    var body: some View {
        NavigationStack {
            //            VStack {
            //                Text("\(selectedBuilding.name ?? "Unknown") > New Connection")
            //                    .font(.system(size: 14))
            //                    .fontWeight(.heavy)
    ...
    struct AddConnection_Preview: PreviewProvider {
        static var previews: some View {
            ...
            return AddConnectionView(selectedBuilding: firstBuilding)
        }
    }
}
