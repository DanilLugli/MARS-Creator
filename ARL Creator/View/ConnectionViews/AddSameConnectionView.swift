...
struct AddSameConnectionView_Preview: PreviewProvider {
    static var previews: some View {
        ...
        return AddSameConnectionView(building: building, initialSelectedFloor: floor, initialSelectedRoom: room)
    }
}
